...
import com.example.capstone_1.DialogActivity;
...
public class SensorService extends Service implements SensorEventListener {
    ...
    private double current_longitude, current_latitude; //GPS를 통해 측정된 위치 값을 다른 액티비티로 넘겨주기 위한 변수
    ...
    LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                //Log.d(TAG, "onLocationResult : " + String.valueOf(location.getLatitude()));
            ...
            if (SMV > 35 ) {
                    if (sentRecently == 'N') {
                        ...
                        if (degreeFloat > 30 || degreeFloat2 > 30) {
                            ...
                            intent.putExtra("lastlat", current_latitude);
                            intent.putExtra("lastlon", current_longitude);
                            ...
                            handler.post(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    Toast.makeText(SensorService.this.getApplicationContext(), "조심하세요!", Toast.LENGTH_LONG).show();
